...
from tensorflow_tts.processor import AghaProcessor
...
from tensorflow_tts.processor.agha import AGHA_SYMBOLS
...
def parse_and_config():
    ...
    parser.add_argument(
        ...
        type=str,
        default="ljspeech",
        choices=["ljspeech", "kss", "libritts", "baker", "thorsten", "agha"],
